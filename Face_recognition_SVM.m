...
%      FACE_RECOGNITION_SVM, by itself, creates a new FACE_RECOGNITION_SVM or raises the existing
%      singleton*.
%
%      H = FACE_RECOGNITION_SVM returns the handle to a new FACE_RECOGNITION_SVM or the handle to
%      the existing singleton*.
%
%      FACE_RECOGNITION_SVM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FACE_RECOGNITION_SVM.M with the given input arguments.
%
%      FACE_RECOGNITION_SVM('Property','Value',...) creates a new FACE_RECOGNITION_SVM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Face_recognition_SVM_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Face_recognition_SVM_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Face_recognition_SVM

% Last Modified by GUIDE v2.5 16-Apr-2015 08:37:48
